...
public class ConfigTestController : ControllerBaseAPI
{
  ...
  public ConfigTestController(ILogger<ConfigTestController> logger,
    IConfiguration config,
    AdvWorksAPIDefaults settings) : base(logger)
  {
    _Config = config;
    _Settings = settings;
  }
  ...
  {
    _Settings.InfoMessageDefault = _Settings.InfoMessageDefault
    .Replace("{Verb}", "GET")
  ...
  public AdvWorksAPIDefaults AssignToClass()
  {
    ...
    settings = _Config.GetRequiredSection("AdvWorksAPI")

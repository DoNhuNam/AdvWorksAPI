...
public class ProductController : ControllerBaseAPI
{
  ...
  public ProductController(IRepository<Product, ProductSearch> repo, 
    ILogger<ProductController> logger,
    IOptionsMonitor<AdvWorksAPIDefaults> settings) : base(logger)
  {
    _Repo = repo;
  ...
  public ActionResult<IEnumerable<Product>> Get()
  {
    ...
    try {
      ...
      InfoMessage = _Settings.InfoMessageDefault
        .Replace("{Verb}", "GET").Replace("{ClassName}", "Product");
